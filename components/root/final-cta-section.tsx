...
export function FinalCTASection({ hkUrl, sgUrl }: FinalCTASectionProps) {
  ...
  return (
    <section ref={ref} className="bg-brand-cream overflow-hidden">
      <div className="px-[5vw] lg:px-[6vw] py-24 lg:py-40">
        <motion.p
          initial={{ opacity: 0 }}
          animate={inView ? { opacity: 1 } : { opacity: 0 }}
          transition={{ duration: 0.7 }}
          className="font-sans text-[0.6rem] tracking-[0.38em] uppercase text-foreground/35 mb-6"
        >
          Next step
        </motion.p>
        ...
        <motion.h2
          ...
          className="font-display font-extrabold text-foreground leading-none tracking-tight text-[clamp(3rem,9vw,9rem)] max-w-[12ch]"
        >
          Ready when you are.
        </motion.h2>
        ...
        <motion.p
          ...
          className="mt-8 font-sans text-[0.8rem] text-foreground/45"
        >
