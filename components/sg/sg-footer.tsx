        ...
        <ContainerEditorial width="wide">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-white/80">
                Kids&apos; sports classes, holiday camps &amp; birthday parties at Katong Point —
                home of Singapore&apos;s only MultiBall wall.
              </p>
            </div>
            ...
            <div>
              ...
              <div>
                ...
                <p className="text-sm text-white/80 flex items-start gap-1 mt-1">
                  ...
                  <span>
                    {KATONG_POINT_NAP.addressStreet}, Singapore {KATONG_POINT_NAP.postalCode}
                  </span>
                </p>
                {phoneSg && <p className="text-sm text-white/80 mt-1">{phoneSg}</p>}
                {whatsappSg && (
                  <a
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                >
                  <Mail className="size-4" aria-hidden="true" /> sg@proactivsports.com
                </a>
                {hkUrl && (
          ...
          <div className="flex flex-col md:flex-row justify-between gap-3 text-sm text-white/60">
            ...
            <div className="flex gap-4">
              <a href={(rootUrl ?? "") + "/privacy/"} className="hover:text-white">
                Privacy
              </a>
              <a href={(rootUrl ?? "") + "/terms/"} className="hover:text-white">
                Terms
              </a>
            </div>
          </div>
