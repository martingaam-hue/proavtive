// Phase 4 / Plan 04-05 — Gymnastics sub-page: Competitive (HK-04).
// Shared template across all 8 /gymnastics/{slug}/ routes. Content is pulled
// from HK_GYMNASTICS_PROGRAMMES[slug === "competitive"]; a Phase 6 CMS migration
...
const PROGRAMME = HK_GYMNASTICS_PROGRAMMES.find((p) => p.slug === "competitive")!;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PROGRAMME.metaTitle,
    description: PROGRAMME.metaDescription,
    url: "https://hk.proactivsports.com/gymnastics/competitive/",
    siteName: "ProActiv Sports Hong Kong",
    locale: "en_HK",
    type: "website",
  },
  alternates: {
    canonical: "https://hk.proactivsports.com/gymnastics/competitive/",
  },
};
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://hk.proactivsports.com/gymnastics/competitive/",
        },
      ],
    },
  ],
...
export default function CompetitiveGymPage() {
