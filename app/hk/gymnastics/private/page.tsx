// Phase 4 / Plan 04-05 — Gymnastics sub-page: Private Coaching (HK-04).
// Shared template across all 8 /gymnastics/{slug}/ routes. Content is pulled
// from HK_GYMNASTICS_PROGRAMMES[slug === "private"]; a Phase 6 CMS migration
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PROGRAMME.metaTitle,
    description: PROGRAMME.metaDescription,
    url: "https://hk.proactivsports.com/gymnastics/private/",
    siteName: "ProActiv Sports Hong Kong",
    locale: "en_HK",
    type: "website",
  },
  alternates: {
    canonical: "https://hk.proactivsports.com/gymnastics/private/",
  },
};
  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://hk.proactivsports.com/gymnastics/private/",
        },
      ],
    },
  ],
