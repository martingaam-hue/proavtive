// Phase 4 / Plan 04-05 — Gymnastics sub-page: Beginner (HK-04).
// Shared template across all 8 /gymnastics/{slug}/ routes. Content is pulled
// from HK_GYMNASTICS_PROGRAMMES[slug === "beginner"]; a Phase 6 CMS migration
...
const PROGRAMME = HK_GYMNASTICS_PROGRAMMES.find((p) => p.slug === "beginner")!;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PROGRAMME.metaTitle,
    description: PROGRAMME.metaDescription,
    url: "https://hk.proactivsports.com/gymnastics/beginner/",
    siteName: "ProActiv Sports Hong Kong",
    locale: "en_HK",
    type: "website",
  },
  alternates: {
    canonical: "https://hk.proactivsports.com/gymnastics/beginner/",
  },
};
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://hk.proactivsports.com/gymnastics/beginner/",
        },
      ],
    },
  ],
...
export default function BeginnerGymPage() {
