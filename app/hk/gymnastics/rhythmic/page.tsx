// Phase 4 / Plan 04-05 — Gymnastics sub-page: Rhythmic (HK-04).
// Shared template across all 8 /gymnastics/{slug}/ routes. Content is pulled
// from HK_GYMNASTICS_PROGRAMMES[slug === "rhythmic"]; a Phase 6 CMS migration
...
const PROGRAMME = HK_GYMNASTICS_PROGRAMMES.find((p) => p.slug === "rhythmic")!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hk.proactivsports.com/gymnastics/rhythmic/",
  },
};
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://hk.proactivsports.com/gymnastics/rhythmic/",
        },
      ],
    },
  ],
...
export default function RhythmicGymPage() {
