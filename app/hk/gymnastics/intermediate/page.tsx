// Phase 4 / Plan 04-05 — Gymnastics sub-page: Intermediate (HK-04).
// Shared template across all 8 /gymnastics/{slug}/ routes. Content is pulled
// from HK_GYMNASTICS_PROGRAMMES[slug === "intermediate"]; a Phase 6 CMS migration
...
const PROGRAMME = HK_GYMNASTICS_PROGRAMMES.find((p) => p.slug === "intermediate")!;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PROGRAMME.metaTitle,
    description: PROGRAMME.metaDescription,
    url: "https://hk.proactivsports.com/gymnastics/intermediate/",
    siteName: "ProActiv Sports Hong Kong",
    locale: "en_HK",
    type: "website",
  },
  alternates: {
    canonical: "https://hk.proactivsports.com/gymnastics/intermediate/",
  },
};
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://hk.proactivsports.com/gymnastics/intermediate/",
        },
      ],
    },
  ],
...
export default function IntermediateGymPage() {
