// Phase 4 / Plan 04-05 — Gymnastics sub-page: Toddlers (HK-04).
// Shared template across all 8 /gymnastics/{slug}/ routes. Content is pulled
// from HK_GYMNASTICS_PROGRAMMES[slug === "toddlers"]; a Phase 6 CMS migration
...
const PROGRAMME = HK_GYMNASTICS_PROGRAMMES.find((p) => p.slug === "toddlers")!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hk.proactivsports.com/gymnastics/toddlers/",
  },
};
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://hk.proactivsports.com/gymnastics/toddlers/",
        },
      ],
    },
  ],
