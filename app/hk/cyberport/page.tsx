// Phase 4 / Plan 04-04 — ProGym Cyberport location page (HK-03).
...
const VENUE = HK_VENUES.find((v) => v.id === "cyberport")!; // build-time constant; fail loud if absent
  ...
  "@graph": [
    {
      ...
      "url": "https://hk.proactivsports.com/cyberport/",
      "telephone":
        process.env.NEXT_PUBLIC_HK_PHONE_CYBERPORT ??
        process.env.NEXT_PUBLIC_HK_PHONE ??
        "",
      "priceRange": "$$",
...
export default function CyberportPage() {
  const phoneHk =
    process.env.NEXT_PUBLIC_HK_PHONE_CYBERPORT ?? process.env.NEXT_PUBLIC_HK_PHONE;
            ...
            <div>
              ...
              {VENUE.sizeNote && (
                <p className="text-body-lg font-semibold text-brand-navy mt-2">
                  {VENUE.sizeNote} · {VENUE.openedNote}
                </p>
              )}
        ...
        <ContainerEditorial width="default">
          <div className="max-w-2xl">
            ...
            <p className="text-body text-muted-foreground">
              ProGym Cyberport serves families across{" "}
              {VENUE.serviceArea.join(", ")}. The Cyberport campus is reached
              via the dedicated Cyberport bus terminus, with regular routes to
              Central, Aberdeen and Pokfulam.
            </p>
          </div>
        </ContainerEditorial>
      </Section>
        ...
        <ContainerEditorial width="default">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-body-lg text-cream mb-6">
              A 30-minute assessment in our newest 5,000 sq ft facility. No
              commitment.
            </p>
            <Button
              asChild
