// Phase 6 / Plan 06-05 — ProGym Wan Chai location page wired to Sanity.
// Fetches venue by slug='wan-chai' from Sanity; falls back to HK_VENUES hardcoded
...
const FALLBACK_VENUE = HK_VENUES.find((v) => v.id === "wan-chai")!;
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-h1 font-display text-foreground">
                <span className="font-accent text-brand-navy">ProGym</span> Wan Chai
              </h1>
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl">
              {sanityVenue?.heroImage ? (
                <SanityImage
                  ...
                  alt={
                    sanityVenue.heroImage.alt ?? "Children practising gymnastics at ProGym Wan Chai"
                  }
                  fill
                  priority
                ...
                <Image
                  ...
                  alt="Children practising gymnastics at ProGym Wan Chai"
                  fill
                  priority
                  sizes="(max-width: 1024px) 100vw, 50vw"
                  className="object-cover"
        ...
        <ContainerEditorial width="wide">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <VenueMap embedSrc={WAN_CHAI_MAP_EMBED} title="Map of ProGym Wan Chai" />
            </div>
            <Card className="p-6">
                ...
                {(openingHours as any[]).map((h: any, i: number) => (
                  <tr key={i} className="border-b border-border">
                    ...
                    <td className="py-3 text-right text-muted-foreground">
                      {"hours" in h
                        ? h.hours
                        : `${"opens" in h ? (h as { opens: string; closes: string }).opens : ""} – ${"closes" in h ? (h as { opens: string; closes: string }).closes : ""}`}
                    </td>
                  </tr>
                ))}
              </tbody>
      ...
      <Section size="md" bg="muted">
        <ContainerEditorial width="wide">
          <h2 className="text-h2 font-display text-foreground mb-6">
            Programmes at <span className="font-accent text-brand-navy">ProGym</span> Wan Chai
          </h2>
        ...
        <ContainerEditorial width="default">
          <div className="max-w-2xl">
            ...
            <p className="text-body text-muted-foreground">
              ProGym Wan Chai serves families across {FALLBACK_VENUE.serviceArea.join(", ")}. The
              Hennessy is a 5-minute walk from Wan Chai MTR (exit B2) and well-served by the 18, 25,
              and 26 bus routes.
            </p>
          </div>
        </ContainerEditorial>
        ...
        <ContainerEditorial width="default">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-body-lg text-cream mb-6">
              A 30-minute assessment with a coach who knows the floor inside-out. No commitment.
            </p>
