// Phase 5 / Plan 05-04 — Multi-Activity Camps sub-page (SG-04).
...
const CAMP = SG_CAMP_TYPES.find((c) => c.slug === "multi-activity")!;
...
export default function MultiActivityCampsPage() {
  return (
    <>
      <script
      ...
      <Section size="sm" bg="default">
        <ContainerEditorial width="wide">
          <div className="relative aspect-[16/9] rounded-xl overflow-hidden">
            <Image
              src="/photography/sg-camp-multi-activity.webp"
              alt="Children in a Multi-Activity Camp at Prodigy, Katong Point — sport rotation across all three zones"
              fill
              priority
        ...
        <ContainerEditorial width="default">
          <div className="max-w-3xl">
            <h2 className="text-h2 font-display text-foreground mb-4">
              Multi-Activity — every sport, every zone.
            </h2>
            <p className="text-body text-muted-foreground">
              {/* Verbatim from strategy PART 6C §6 multi-activity camps */}
              {CAMP.description}
            </p>
          </div>
        </ContainerEditorial>
        ...
        <ContainerEditorial width="default">
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="text-h2 font-display text-white mb-3">
              Book a Multi-Activity Camp place.
            </h2>
            <p className="text-body-lg text-cream mb-6">
              Ages 4–12. Every school holiday. The ideal camp for children who
              love variety.
            </p>
            <Button
              asChild
            ...
            >
              <a href="/book-a-trial/?subject=multi-activity-camp">
                Book a Camp Place
